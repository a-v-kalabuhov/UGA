...
//  SF_AGREED = 'AGREED';
  ...
  SF_CAN_MS_PRINT = 'CAN_MS_PRINT';
  SF_CAN_MS_PROJECTS = 'CAN_MS_PROJECTS';
  ...
  SF_CHILD = 'CHILD';
  SF_CK36 = 'CK36';
  SF_CLASS_ID = 'CLASS_ID';
  SF_CLASS_NAME = 'CLASS_NAME';
  SF_CLOSED = 'CLOSED';
  SF_COLOR = 'COLOR';
  SF_COMMENT = 'COMMENT';
  SF_COMMENTS = 'COMMENTS';
  SF_CONNECTED_TO = 'CONNECTED_TO';
  SF_CONFIRM_DATE = 'CONFIRM_DATE';
  SF_CERTIF_DATE = 'CERTIF_DATE';
  SF_CERTIF_NUMBER = 'CERTIF_NUMBER';
  ...
  SF_CUSTOMER_ORGS_ID = 'CUSTOMER_ORGS_ID';
  ...
  SF_DESTROYED = 'DESTROYED';
  SF_DIAM = 'DIAM';
  SF_DIAMETER = 'DIAMETER';
  SF_DIAMETER_COMMENT = 'DIAMETER_COMMENT';
  SF_DIRECTOR = 'DIRECTOR';
  SF_DIRECTOR_L = 'DIRECTOR_L';
  SF_DISMANTLED = 'DISMANTLED';
...
//  SF_DOC_YEAR = 'DOC_YEAR';
  ...
  SF_DRAW_DATE = 'DRAW_DATE';
  SF_DRAW_ORGS_ID = 'DRAW_ORGS_ID';
  SF_DRAWER_NAME = 'DRAWER_NAME';
  SF_DRAWER_ORG = 'DRAWER_ORG';
  SF_DRAWN = 'DRAWN';
  SF_ENABLED = 'ENABLED';
  ...
  SF_EXCHANGE_XY = 'EXCHANGE_XY';
  SF_EXECUTED = 'EXECUTED';
  SF_EXECUTED_2 = 'EXECUTED_2';
  SF_EXECUTE_INFO = 'EXECUTE_INFO';
  SF_EXECUTOR = 'EXECUTOR';
  SF_EXECUTOR_NAME = 'EXECUTOR_NAME';
  SF_EXECUTOR_ORGS_ID = 'EXECUTOR_ORGS_ID';
  SF_EXPIRED = 'EXPIRED';
...
//  SF_FIGURE_NUMBER = 'FIGURE_NUMBER';
  ...
  SF_GUID = 'GUID';
  SF_HAS_BACKCOLOR = 'HAS_BACKCOLOR';
  SF_HAS_CERTIF = 'HAS_CERTIF';
  SF_HEADER = 'HEADER';
  SF_HEAD_ID = 'HEAD_ID';
  ...
  SF_LINE_ID = 'LINE_ID';
  SF_LINE_COLOR = 'LINE_COLOR';
  SF_LINKED_OBJ_ID = 'LINKED_OBJ_ID';
  SF_LOADED = 'LOADED';
  SF_MAP_500_ID = 'MAP_500_ID';
  SF_MAP_ORIGIN_ORG = 'MAP_ORIGIN_ORG';
  SF_MAP_REPORT_ERROR_MODE = 'MAP_REPORT_ERROR_MODE';
  SF_MAP_TRACINGS_ID = 'MAP_TRACINGS_ID';
  SF_MAPPER_FIO = 'MAPPER_FIO';
  SF_MARK_EXECUTOR = 'MARK_EXECUTOR';
  SF_MARKING_ID = 'MARKING_' + SF_ID;
  SF_MASTER_PLAN_ID = 'MASTER_PLAN_ID';
  SF_MASTER_PLAN_CLASS_ID = 'MASTER_PLAN_CLASS_ID';
  SF_MASTER_PLAN_LAYERS_ID = 'MASTER_PLAN_LAYERS_ID';
  ...
  SF_OBJ_ID = 'OBJ_ID';
  SF_OBJ_VERSION = 'OBJ_VERSION';
  SF_OBJECT_ADDRESS = 'OBJECT_ADDRESS';
  SF_OBJECT_ID = 'OBJECT_ID';
...
//  SF_PPD_DOCS_ID = 'PPD_DOCS_' + SF_ID;
  SF_PRESSURE_IDX = 'PRESSURE_IDX';
  SF_PRESSURE_INDEX = 'PRESSURE_INDEX';
  SF_PRESSURE_TXT = 'PRESSURE_TXT';
  SF_PRICE = 'PRICE';
  ...
  SF_PROJECT_ID = 'PROJECT_ID';
  SF_PROJECT_NAME = 'PROJECT_NAME';
  SF_PROJECTS_ID = 'PROJECTS_ID';
  SF_PROJECT_LAYERS_ID = 'PROJECT_LAYERS_ID';
  SF_PROJECT_LINES_ID = 'PROJECT_LINES_ID';
  SF_PROJECT_PLACES_ID = 'PROJECT_PLACES_ID';
  SF_PROJECTED = 'PROJECTED';
  ...
  SF_REQUEST_DATE = 'REQUEST_DATE';
  SF_REQUEST_NUMBER = 'REQUEST_NUMBER';
  SF_REQUIRED = 'REQUIRED';
  SF_ROLE_NAME = 'ROLE_' + SF_NAME;
  SF_ROOM = 'ROOM';
  SF_ROTANGLE = 'ROTANGLE';
  SF_ROTATION = 'ROTATION';
  ...
  SF_TABLE_VERSION = 'TABLE_VERSION';
  ...
  SF_UNDERGROUND = 'UNDERGROUND';
  SF_UNIT = 'UNIT';
  SF_USER_ACTION = 'USER_ACTION';
  ...
  SF_VOLTAGE = 'VOLTAGE';
  SF_VOLTAGE_COMMENT = 'VOLTAGE_COMMENT';
  SF_VOLTAGE_IDX = 'VOLTAGE_IDX';
  SF_VOLTAGE_INDEX = 'VOLTAGE_INDEX';
  SF_VOLTAGE_TXT = 'VOLTAGE_TXT';
  SF_VRS = 'VRS';
  ...
  SF_YEAR_NUMBER = 'YEAR_NUMBER';
{
  ...
  SG_MP_OBJECTS_TABLE_VERSION = 'MP_OBJECTS_TABLE_VERSION';
  SG_LAYERS = 'LAYERS';
  SG_LAYERS_SEMANTIC = 'LAYERS_SEMANTIC';
  SG_MP_OBJECTS = 'MP_OBJECTS';
  SG_PROJECTS = 'PROJECTS';
  SG_PROJECT_LINES = 'PROJECT_LINES';
  SG_PROJECT_LINE_POINTS = 'PROJECT_LINE_POINTS';
  SG_PROJECT_PLACES_GEN = 'PROJECT_PLACES_GEN';
  SG_TABLE_VERSION = 'TABLE_VERSION';
  ...
  SQL_SELECT_LICENSED_ORG_NAME = 'SELECT NAME FROM LICENSED_ORGS WHERE ID=:ID';
  ...
  SL_PROJECT_IMPORT = 'PRJ_IMPORT';
  SL_PROJECT_OPEN = 'PRJ_OPEN';
  SL_PROJECT_CLOSED = 'PRJ_CLOSED';

  SL_MASTER_PLAN = 'MASTER_PLAN';
  SLF_LAYER_ID = 'LAYER_ID';
  SLF_LINE_ID = 'LINE_ID';
  SLF_NET_ID = 'NET_ID';
  SLF_OBJECT_ID = 'OBJECT_ID';
  SLF_PROJECT_ID = 'PROJECT_ID';
  SLF_UID = 'UID';
