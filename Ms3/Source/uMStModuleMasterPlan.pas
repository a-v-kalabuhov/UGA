...
//  + 'DELETED = :DELETED, '
  ...
  + ' EZ_ID,            EZ_RECNO,         MINX,                     MINY,             MAXX, '
  + ' MAXY,             LOADED,           PROJECT_NAME,             CUSTOMER_ORGS_ID, EXECUTOR_ORGS_ID, '
  + ' OWNER_ORG_ID,     DRAW_ORGS_ID,     DELETED,                  TABLE_VERSION,    DRAWN, '
  + ' PROJECTED,        CERTIF_DATE,      CERTIF_NUMBER,            HAS_CERTIF,       CHECK_STATE, '
  + ' LINKED_OBJ_ID,    CHECKED,          PROJECTS_ID,              PROJECT_LINES_ID, PROJECT_PLACES_ID, '
  + ' VOLTAGE_COMMENT,  DIAMETER_COMMENT, COMMENT,                  CONFIRM_DATE,     SEWER, '
  + ' PRESSURE_INDEX,   VOLTAGE_INDEX) '
  + 'SELECT '
  + ' :NEW_ID,          :OBJ_ID,          MASTER_PLAN_CLASS_ID,     STATUS,           DISMANTLED, '
  + ' ARCHIVED,         CONFIRMED,        ADDRESS,                  DOC_NUMBER,       DOC_DATE, '
  + ' REQUEST_NUMBER,   REQUEST_DATE,     UNDERGROUND,              DIAMETER,         PIPE_COUNT, '
  + ' VOLTAGE,          MATERIAL,         TOP,                      BOTTOM,           FLOOR, '
  + ' OWNER,            DRAW_DATE,        IS_LINE,                  ROTATION,         EZDATA, '
  + ' EZ_ID,            EZ_RECNO,         MINX,                     MINY,             MAXX, '
  + ' MAXY,             LOADED,           PROJECT_NAME,             CUSTOMER_ORGS_ID, EXECUTOR_ORGS_ID,'
  + ' OWNER_ORG_ID,     DRAW_ORGS_ID,     DELETED,                  :TABLE_VERSION,   1, '
  + ' PROJECTED,        CERTIF_DATE,      CERTIF_NUMBER,            HAS_CERTIF,       CHECK_STATE, '
  + ' :LINKED_OBJ_ID,   CHECKED,          PROJECTS_ID,              PROJECT_LINES_ID, PROJECT_PLACES_ID, '
  + ' VOLTAGE_COMMENT,  DIAMETER_COMMENT, COMMENT,                  CONFIRM_DATE,     SEWER, '
  + ' PRESSURE_INDEX,   VOLTAGE_INDEX '
