...
type
  ...
  public
    ...
    //
    property Header: TEntityHeader read FHeader;
  end;
  ...
  private
    ...
    FEntityCount: Word;
    function GetMapEntity(Index: Integer): TMapEntity;
  ...
  public
    ...
    procedure LoadFromStream(Stream: TStream);
    //
    property Entities[Index: Integer]: TMapEntity read GetMapEntity;
...
function TMapFile.GetEntityCount: Integer;
begin
  Result := FEntities.Count;
end;

function TMapFile.GetMapEntity(Index: Integer): TMapEntity;
begin
  Result := FEntities[Index] as TMapEntity;
end;
...
function TMapPolygon.GetPoint(Index: Integer): TMapPoint;
begin
  Result.X := FHeader.X + Points[Index].C.x;
  Result.Y := FHeader.Y + Points[Index].C.y;
end;
