...
// PASTLWTR : 1.2
// File generated on 29.09.2003 12:04:22 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\WINNT\System32\Richtx32.ocx (1)
// LIBID: {3B7C8863-D78F-101B-B9B5-04021C009402}
// LCID: 0
// Helpfile: C:\WINNT\System32\RTFBox98.CHM
// HelpString: Microsoft Rich Textbox Control 6.0 (SP4)
// DepndLst: 
...
// *********************************************************************//
  TRichTextBoxOLEStartDrag = procedure(ASender: TObject; var Data: DataObject; 
                                                         var AllowedEffects: Integer) of object;
  TRichTextBoxOLEGiveFeedback = procedure(ASender: TObject; var Effect: Integer; 
                                                            var DefaultCursors: WordBool) of object;
  TRichTextBoxOLESetData = procedure(ASender: TObject; var Data: DataObject; 
                                                       var DataFormat: Smallint) of object;
  TRichTextBoxOLECompleteDrag = procedure(ASender: TObject; var Effect: Integer) of object;
  TRichTextBoxOLEDragOver = procedure(ASender: TObject; var Data: DataObject; var Effect: Integer; 
                                                        var Button: Smallint; var Shift: Smallint; 
                                                        var x: Single; var y: Single; 
                                                        var State: Smallint) of object;
  TRichTextBoxOLEDragDrop = procedure(ASender: TObject; var Data: DataObject; var Effect: Integer; 
                                                        var Button: Smallint; var Shift: Smallint; 
...
begin
  ...
  Result := InterfaceVariant.SelAlignment;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelBold;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelBullet;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelCharOffset;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelColor;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelFontName;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelFontSize;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelHangingIndent;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelIndent;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelItalic;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelProtected;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelRightIndent;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelStrikeThru;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelTabCount;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelUnderline;
end;
...
begin
    Result := DefaultInterface.OLEObjects;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.SelTabs[sElement];
end;

procedure TRichTextBox.Set_SelTabs(sElement: Smallint; pvarSelTab: OleVariant);
begin
  DefaultInterface.SelTabs[sElement] := pvarSelTab;
end;
...
begin
    Result := DefaultInterface.Item[Item];
end;
...
procedure TOLEObject.Set_Key(const pbstrKey: WideString);
  { Warning: The property Key has a setter and a getter whose
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.ObjectVerbs;
end;
...
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.ObjectVerbFlags;
end;

function TOLEObject.Get_ObjectVerbsCount: SYSINT;
begin
    Result := DefaultInterface.ObjectVerbsCount;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TRichTextBox]);
  RegisterComponents(dtlServerPage, [TOLEObjects, TOLEObject]);
end;
