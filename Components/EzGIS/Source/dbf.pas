...
//============ TIndex
//==========================================================
constructor TIndex.Create(Parent:TIndexFile; RootPage:integer;Create:boolean);
var
  lPos:TIndexPage;
  lChild:TIndexPage;
begin
...
begin
  ...
  while p.Entry._LowerPage>0 do begin
    p:=p.LowerLevel;
    pos:=pos*(_NdxHdr.nbkey+1) + p._EntryNo;
  end;
  result:=pos;
end;
...
begin
  pos:=_Root;
  while pos._LowerLevel<>nil do begin
    pos:=pos.LowerLevel;
  end;
  if (pos._EntryNo<0) or (pos._EntryNo>=pos._PageBuff.NbEntries) then Result:=-1
  else Result:=pos.Entry.RecNo-1;
end;
