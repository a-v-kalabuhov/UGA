...
begin
  ...
  cboSize.ItemIndex:= 5;
  NumEd1.NumericValue:= fMain.Form1.DrawBox.Grapher.DistToRealY(StrToIntDef(cboSize.Text, 12));
...
begin
  ...
  try
    ...
    Accept:= True;
    If Assigned( fMain.Form1.DrawBox.OnBeforeInsert ) Then
      fMain.Form1.DrawBox.OnBeforeInsert( Self, Layer, FPlace, Accept );
    ...
    If Assigned( fMain.Form1.DrawBox.OnAfterInsert ) Then
      fMain.Form1.DrawBox.OnAfterInsert( Self, Layer, Recno );
...
begin
  ...
  Launcher1.Finish;
  fMain.Form1.actSymbolMult.Checked:=false;
  FPlace.Free;
