...
begin
  Form1.DrawBox.TempEntities.Clear;
...
begin
  ...
  Radius:= fMain.Form1.DrawBox.Grapher.PointsToDistY( EzNumEd1.NumericValue );
  ...
  fMain.Form1.DrawBox.TempEntities.Add(Ellipse);
  fMain.Form1.DrawBox.Refresh;
end;
...
begin
  ...
  { calculate it }
  Network1.FindShortPath( fMain.Form1.DrawBox, FNetworkLayer, RouteLayer );
  ...
  begin
    ...
    Grid1.Cells[1,Routeno] := Format('Total Cost %.*n', [fMain.Form1.DrawBox.NumDecimals, Network1.TotalCosts[RouteNo-1]] );
  end;
