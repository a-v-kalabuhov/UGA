...
uses Windows, SysUtils, Classes, Graphics, Forms, Controls, StdCtrls,
  ...
  EzPreview, fAccuDraw, fAccuSnap, ImgList, ActnList, ActnMan, ToolWin,
  ActnCtrls, ActnMenus, XPStyleActnCtrls;

const
  LAYOUT_VERSION = Integer(100);
  LAYOUT_IDENT = 080504;
...
type
  TfrmDemoPreview = class(TForm)
    ...
    procedure actZoomRTExecute(Sender: TObject);
...
{$ENDIF}
    ...
    Procedure CreateNewLayout(PaperSize: TEzPaperSize;
      PaperUnits: TEzScaleUnits; PutDefaultMap: Boolean);
...
uses
  ...
  EzActionLaunch, fAccuDrawSetts, fAccuSnapSetts, fMain
{$IFDEF GIS_CONTROLS}
  , fLegend, EzThematics
{$ENDIF}
  , fNewLayout, fSymbolType;
...
begin
  ...
  begin
    ...
    AddMap(0, MarginLeft, -MarginTop,
      PreviewBox1.PrintablePageWidth,
      PreviewBox1.PrintablePageHeight,
      PlottedUnits, DrawingUnits, (xmin+xmax)/2, (ymin+ymax)/2, True);
...
{$IFDEF FALSE}
    ...
    DecimalSeparator:= '.';
    AddEntityFromText('',
      Format('RECTANGLE (%f, %f), (%f, %f)',[0.32,-1.24,0.32+7.36,-(1.24+6.3)]) );
...
procedure TfrmDemoPreview.AccuDrawFormClose(Sender: TObject);
begin
  FfrmAccuDraw:= Nil;
...
begin
  ...
  begin
    ...
    begin
      ...
      p:= Self.ClientToScreen(Point(Panel2.Left,Panel2.Top));
...
procedure TfrmDemoPreview.actPrintExecute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action1Execute(Sender: TObject);
begin
  Close;
end;

procedure TfrmDemoPreview.Action6Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action7Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action8Execute(Sender: TObject);
begin
  PreviewBox1.Undo.CopyToClipboardFromSelection;
end;

procedure TfrmDemoPreview.Action9Execute(Sender: TObject);
begin
  PreviewBox1.Undo.PasteFromClipboardTo();
end;

procedure TfrmDemoPreview.Action10Execute(Sender: TObject);
begin
  PreviewBox1.DeleteSelection;
end;

procedure TfrmDemoPreview.Action11Execute(Sender: TObject);
var
  I,J: Integer;
...
procedure TfrmDemoPreview.Action12Execute(Sender: TObject);
begin
  CmdLine1.DoCommand( Clipboard.AsText, '' );
end;

procedure TfrmDemoPreview.Action13Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action14Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action15Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action16Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action18Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action19Execute(Sender: TObject);
var
  Code: Integer;
  S: string;
  Rot:Double;
...
procedure TfrmDemoPreview.Action20Execute(Sender: TObject);
begin
  CmdLine1.AccuDraw.ShowUnrotated;
end;

procedure TfrmDemoPreview.Action21Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action31Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action27Execute(Sender: TObject);
begin
  fAlignment.WinHandle:= Self.Handle;
  TfrmAlignPalette.Create(Application).Enter(Self.PreviewBox1);
end;

procedure TfrmDemoPreview.Action22Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('MOVE','');
end;

procedure TfrmDemoPreview.Action23Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('SCALE','');
end;

procedure TfrmDemoPreview.Action24Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('ROTATE','');
end;

procedure TfrmDemoPreview.Action25Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('RESHAPE','');
end;

procedure TfrmDemoPreview.Action28Execute(Sender: TObject);
begin
  PreviewBox1.ZoomToPaper;
end;

procedure TfrmDemoPreview.Action29Execute(Sender: TObject);
var
...
procedure TfrmDemoPreview.Action30Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('SELECT','');
end;

procedure TfrmDemoPreview.Action32Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('HINTS','');
end;

procedure TfrmDemoPreview.Action33Execute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.Action34Execute(Sender: TObject);
begin
  if frmMosaic = Nil then
  begin
...
procedure TfrmDemoPreview.Action35Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('ZOOMWIN','');
end;

procedure TfrmDemoPreview.Action36Execute(Sender: TObject);
begin
  PreviewBox1.ZoomPrevious;
end;

procedure TfrmDemoPreview.Action37Execute(Sender: TObject);
begin
  CmdLine1.Clear;
  CmdLine1.DoCommand(SCmdZoomIn,'');
end;

procedure TfrmDemoPreview.Action38Execute(Sender: TObject);
begin
  CmdLine1.Clear;
  CmdLine1.DoCommand(SCmdZoomOut,'');
end;

procedure TfrmDemoPreview.Action39Execute(Sender: TObject);
begin
   CmdLine1.DoCommand('SCROLL','');
end;

procedure TfrmDemoPreview.Action41Execute(Sender: TObject);
var
...
procedure TfrmDemoPreview.Action43Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('PICTUREREF','');
end;

procedure TfrmDemoPreview.Action44Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('LINE','');
end;

procedure TfrmDemoPreview.Action42Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('PLINE','');
end;

procedure TfrmDemoPreview.Action45Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('POLYGON','');
end;

procedure TfrmDemoPreview.Action51Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('TEXT','');
end;

procedure TfrmDemoPreview.Action52Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('FITTEDTEXT','');
end;

procedure TfrmDemoPreview.Action53Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('JUSTIFTEXT','');
end;

procedure TfrmDemoPreview.Action40Execute(Sender: TObject);
begin
 CmdLine1.Clear;
 CmdLine1.DoCommand('TABLE','');
end;

procedure TfrmDemoPreview.Action50Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('ARC','');
end;

procedure TfrmDemoPreview.Action46Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('ELLIPSE','');
end;

procedure TfrmDemoPreview.Action47Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('CIRCLE3P','');
end;

procedure TfrmDemoPreview.Action48Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('CIRCLECR','');
end;

procedure TfrmDemoPreview.Action49Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('RECTANGLE','');
end;

procedure TfrmDemoPreview.Action54Execute(Sender: TObject);
begin
  CmdLine1.Clear;
  CmdLine1.DoCommand('ARCSE','');
end;

procedure TfrmDemoPreview.Action55Execute(Sender: TObject);
begin
  CmdLine1.Clear;
  CmdLine1.DoCommand('ARCFCS','');
end;

procedure TfrmDemoPreview.Action2Execute(Sender: TObject);
begin
  with TfrmNewLayout.create(Nil) do
    try
      cboUnits.ItemIndex:= 0;
      cboSize.ItemIndex:= 0;
      if showmodal=mrOk then
      begin
        CreateNewLayout( TEzPaperSize(cboSize.ItemIndex),
                         TEzScaleUnits(cboUnits.ItemIndex),
                         check1.checked );
      end;
    finally
      free;
...
procedure TfrmDemoPreview.Action3Execute(Sender: TObject);
var
  stream: TStream;
  PaperSize: TEzPaperSize;
...
begin
  ...
  FLayoutFileName:= OpenDialog1.FileName;
  stream:= TFileStream.create(FLayoutFileName, fmOpenRead or fmShareDenyNone);
  try
    with stream do
    begin
      Read(Version,sizeof(Integer));
      Read(Identifier,sizeof(Integer));
      if Not ( (Version = LAYOUT_VERSION) And (Identifier = LAYOUT_IDENT) ) then Exit;
      Read(Papersize,sizeof(Papersize));
      Read(Paperunits,sizeof(Paperunits));
      { count number of records }
      Read(Numrecs,sizeof(Numrecs));

      { create the new editor }
      CreateNewLayout( PaperSize, PaperUnits, False );
      Layer:= Previewbox1.Gis.Layers[0];
      for I:= 1 to Numrecs do
      begin
        Read(id,sizeof(id));
        TmpClass := GetClassFromID( id );
        Ent := TmpClass.Create( 1 );
...
procedure TfrmDemoPreview.Action4Execute(Sender: TObject);
begin
  if Length(FLayoutFileName) = 0 then
  begin
    if not SaveDialog1.Execute then exit;
    FLayoutFileName:= SaveDialog1.FileName;
  end;
  SaveLayout;
end;

procedure TfrmDemoPreview.SaveLayout;
var
  stream: TStream;
  PaperSize: TEzPaperSize;
  PaperUnits: TEzScaleUnits;
  ...
  Layer: TEzBaseLayer;
begin
  { save the layout stored in FLayoutFileName}
  if Length(FLayoutFileName) = 0 then exit;
  PaperSize:= Previewbox1.PaperSize;
  PaperUnits:= Previewbox1.PaperUnits;
  stream:= TFileStream.create(FLayoutFileName, fmCreate);
  try
    with stream do
    begin
      Version:= LAYOUT_VERSION;
      Identifier:= LAYOUT_IDENT;
      Write(Version,sizeof(Integer));
      Write(Identifier,sizeof(Integer));
      Write(Papersize,sizeof(Papersize));
      Write(Paperunits,sizeof(Paperunits));
      { count number of records }
      Numrecs:= 0;
      Layer:= Previewbox1.Gis.Layers[0];
...
procedure TfrmDemoPreview.Action5Execute(Sender: TObject);
begin
  if not SaveDialog1.Execute then exit;
  FLayoutFileName:= SaveDialog1.FileName;
  SaveLayout;
...
procedure TfrmDemoPreview.CreateNewLayout(PaperSize: TEzPaperSize;
  PaperUnits: TEzScaleUnits; PutDefaultMap: Boolean);
var
  xmin,ymin,xmax,ymax, dx, dy: Double;
  PlottedUnits: Double;
  DrawingUnits: Double;
begin
  PreviewBox1.PaperUnits:= PaperUnits;
  PreviewBox1.PaperSize:= PaperSize;
  PreviewBox1.ConfigurePaperShapes;
  PreviewBox1.CreateNewEditor;
  PreviewBox1.Gis.OnGisTimer:= PreviewBox1GisTimer;
  if PutDefaultMap then
  begin
    FDrawBox.CurrentExtents(Xmin,Ymin,Xmax,Ymax);
    with PreviewBox1 do
    begin
      ...
      with Ez_Preferences.DefBrushStyle do
      begin
        Pattern:=1;
        ForeColor:=clWhite;
      end;
...
procedure TfrmDemoPreview.Action26Execute(Sender: TObject);
begin
  CmdLine1.DoCommand('MEASURES','');
end;

procedure TfrmDemoPreview.actZoomRTExecute(Sender: TObject);
begin
  CmdLine1.Clear;
...
procedure TfrmDemoPreview.AccusnapClose(Sender: TObject);
begin
  FfrmAccuSnap:= Nil;
  actAccuSnapShow.Checked:= False;
end;

procedure TfrmDemoPreview.actAccuSnapShowExecute(Sender: TObject);
var
  p: TPoint;
begin
...
procedure TfrmDemoPreview.actAccuSnapConfigExecute(Sender: TObject);
begin
...
procedure TfrmDemoPreview.CmdLine1AccuSnapChange(Sender: TObject);
begin
  if FfrmAccuSnap=nil then Exit;
  FfrmAccuSnap.ResetToDefault;
end;

procedure TfrmDemoPreview.actHelpExecute(Sender: TObject);
begin
  ShowMessage('Hold down the CTRL key while using the '#10#13'Zoom Window, Zoom In, Zoom Out, Scroll tools'#10#13'In order to zoom the map');
end;
