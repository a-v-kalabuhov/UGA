...
uses
  Windows, Messages, SysUtils, Classes, Graphics, FR_Class, StdCtrls, Variants,
...
procedure TfrDBLookupControl.DropDown(Sender: TObject);
begin
  FLookup.ListSource.DataSet.Last;
end;
