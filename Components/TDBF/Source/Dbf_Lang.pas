...
// ...
  ...
  DbfLangId_Ascii_Ansi    = $57;
  DbfLangId_WEurope_Ansi  = $58;
  DbfLangId_Spanish_Ansi  = $59;
// ...
...
{58}    1252, 1252,    0,    0,    0,    0,  437,  437,     // FoxPro: last two
{60}     850, 1252, 1252,    0,    0,    0,    0,    0,     // FoxPro
{68}       0,  620,    0,    0,    0,    0,    0,    0,
{70}       0,    0,    0,    0,    0,    0,    0,    0,
{78}       0,    0,    0,    0,    0,    0,    0,    0,
{80}       0,    0,    0,    0,    0,  862,  437,  852,
{88}     857,    0,    0,    0,    0,    0,  868,    0,
{90}       0,    0,    0,    0,    0,    0,    0,    0,
{98}       0,    0,    0, 1250,  850,    0,    0,    0,     // FoxPro
{A0}       0,    0,    0,    0,    0,    0,    0,    0,
{A8}       0,    0,    0,    0,    0,    0,    0,    0,
{B0}       0,    0,    0,    0,    0,    0,    0,    0,
{B8}       0,    0,    0,    0,    0,    0,    0,    0,
...
// table
  ...
  LangId_To_Locale: array[Byte] of LCID =
      (
      DbfLocale_NotFound,0,0,0,0,0,0,0,
...
{5E}  LANG_GERMAN     or (SUBLANG_GERMAN               shl 10) or (SORT_DEFAULT shl 16),
      ...
      LANG_NORWEGIAN  or (SUBLANG_DEFAULT              shl 10) or (SORT_DEFAULT shl 16),
{63}  0,0,0,0,0,0,
{69}  LANG_POLISH     or (SUBLANG_DEFAULT              shl 10) or (SORT_DEFAULT shl 16),
{6A}  0,0,0,0,0,0,
...
const
  dBase_RegionCount = 3;
  dBase_Regions: array[0..dBase_RegionCount*2-1] of Byte = ($00, $5D, $63, $9A, $9D, $FF);
